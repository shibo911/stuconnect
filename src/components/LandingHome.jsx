        ...
        <div>
            <section class="text-gray-600 body-font mx-12">
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 class="title-font sm:text-4xl text-9xl mb-4 font-bold text-gray-900">We are Building
                            <br class="hidden lg:inline-block" />Things For Future
                        </h1>
                        <p class="mb-8 leading-relaxed">
                        Join StuConnect today to become part of a dynamic network where learning and growth thrive through community engagement.
                        </p>
                        <div class="flex justify-center">
                            <Link to="/sign-in" class="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Sign In</Link>
                            <Link to="/sign-up" class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">Sign Up</Link>
                        </div>
                    </div>
                    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                        <img class="object-cover object-center rounded" alt="hero" src="https://source.unsplash.com/featured?technology" />
                    </div>
                </div>
            </section>
            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font text-center text-gray-900 mb-20">Services
            ...
            <section class="text-gray-600 body-font">
                <div class="container px-5 py-24 mx-auto">
                    <div class="flex flex-col text-center w-full mb-20">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Our Growth & Success</h1>
            ...
            <section class="text-gray-600 body-font mx-12">
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    <div class="flex flex-wrap w-full">
                        <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                            <div class="flex relative pb-12">
                                ...
                                <div class="flex-grow pl-4">
                                    <h2 class="font-bold title-font text-sm text-gray-900 mb-1 tracking-wider">Feasibility analysis</h2>
                                    <p class="leading-relaxed">The feasibility study can show how to make your own software profitable in the long run, evaluates all factors including economic and technical that affect the project development.</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    <h2 class="font-bold title-font text-sm text-gray-900 mb-1 tracking-wider">Designing & Modelling</h2>
                            ...
                            <div class="flex relative pb-12">
                                ...
                                <div class="flex-grow pl-4">
                                    <h2 class="font-bold title-font text-sm text-gray-900 mb-1 tracking-wider">Construction</h2>
                                    <p class="leading-relaxed">
                            ...
                            <div class="flex relative pb-12">
                                ...
                                <div class="flex-grow pl-4">
                                    <h2 class="font-bold title-font text-sm text-gray-900 mb-1 tracking-wider">Quality Assurance</h2>
                                    <p class="leading-relaxed">
                            ...
                            <div class="flex relative">
                                ...
                                <div class="flex-grow pl-4">
                                    <h2 class="font-bold title-font text-sm text-gray-900 mb-1 tracking-wider">Deployment & Release</h2>
                                    <p class="leading-relaxed">
                        ...
                        <img class="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://source.unsplash.com/featured?team" alt="step" />
                    </div>
                </div>
            </section>
                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 md:w-1/2 w-full">
                            <div class="h-full bg-gray-100 p-8 rounded">
                                ...
                                <a class="inline-flex items-center">
                                    <img alt="testimonial" src="https://source.unsplash.com/featured?person" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                        ...
                        <div class="p-4 md:w-1/2 w-full">
                            <div class="h-full bg-gray-100 p-8 rounded">
                                ...
                                <a class="inline-flex items-center">
                                    <img alt="testimonial" src="https://source.unsplash.com/featured?user" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                    <span class="flex-grow flex flex-col pl-4">
            ...
            <footer class="text-gray-600 body-font">
                    ...
                    <div class="flex flex-wrap md:text-left text-center order-first">
                        ...
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                                ...
                                <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Get Feed</button>
                            </div>
                            <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Subcribe to our Monthly Newsletter
                                <br class="lg:block hidden" />to stay updated about latest Services, Offerings & Discount seasons.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-100">
                    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2020 YPMedia —
